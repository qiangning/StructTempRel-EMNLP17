...
public class SL_exp {
    ...
    public static String MODELDIR = "SL_models/ClearTK";
    public static void main(String[] args) throws Exception{
        ...
        if(development) {
            ...
            String golddir = "./output/ClearTK/SL/dev/gold_dev";
            String logdir = "ClearTK_dev";
            ...
            for (int iter : iters) {
                for (float rate : rates) {
                    ...
                    for (double kl : thresholds) {
                        ...
                        String outdir = "./output/ClearTK/SL/dev/pred" + "_" + tag;
            ...
            /*-----TESTING-----*/
            String outdir = "./output/ClearTK/SL/pred" + "_" + bestiter + "_" + String.valueOf(bestrate) + "_" + String.valueOf(bestth);
            IOUtils.mkdir(outdir);
            System.out.println("Testing on Test Data");
    ...
    public static void test(SLProblem sp, String modelPath, String outdir, boolean gold_et_or_not, double kl_th)
        ...
        String cacheDir = "serialized_data/TBVC_SL";
    ...
    public static SLProblem getStructuredTrainData() throws Exception{
        ...
        List<TemporalDocument> docs = TempEval3Reader.deserialize("./serialized_data/aug_Bethard/TimeBank");
        int cnt=0;
