...
// 
...
public class et_perceptron extends SparseNetworkLearner
{
  ...
  static
  {
    _lcFilePath = et_perceptron.class.getResource("et_perceptron.lc");
    _lexFilePath = et_perceptron.class.getResource("et_perceptron.lex");
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      if (_lcFilePath == null)
      {
        throw new RuntimeException("Can't locate et_perceptron.lc in the class path.");
      }
      if (_lexFilePath == null)
      {
        throw new RuntimeException("Can't locate et_perceptron.lc in the class path.");
      }
      instance = (et_perceptron) Learner.readLearner(_lcFilePath);
  ...
  public static et_perceptron instance;

  public static et_perceptron getInstance()
  {
    loadInstance();
    return instance;
  }

  private et_perceptron(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.etLearningRate, 0, ParamLBJ.etThickness));
  ...
  public et_perceptron()
  {
    super("edu.illinois.cs.cogcomp.nlp.classifier.lbj.perceptron.et.et_perceptron");
    isClone = true;
  }

  public et_perceptron(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public et_perceptron(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(et_perceptron.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(et_perceptron.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(et_perceptron.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.nlp.classifier.lbj.perceptron.et";
      name = "et_perceptron";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof LearningObj || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'et_perceptron(LearningObj)' defined on line 20 of et_perceptron.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.nlp.classifier.lbj.perceptron.et.et_perceptron \\");
    ...
    et_perceptron classifier = new et_perceptron();
  ...
  public int hashCode() { return "et_perceptron".hashCode(); }
  public boolean equals(Object o) { return o instanceof et_perceptron; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new et_perceptron(false).getParameters()); }
  }
}
